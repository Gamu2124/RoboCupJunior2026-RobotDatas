...
private:
  ...
  int ball_invariable_flag = 0;
  int cam_invariable_flag = 0;
  int invariable_flag = 0;
  float invariable_ball_angle = 0;
  float invariable_ball_far = 0;
  float invariable_back_cam_angle = 0;
